        ...
        elem.oninput = function(evt) {
            ...
            if (val != null) {
                ...
                if (evt.keyCode == 32) {
                    ...
                    var xmlResponse = fetch("http://localhost:8080/https://rule34.xxx/public/autocomplete.php?q=" + val, {headers:headers})
                        .then( (response) => {
                            if (!response.ok) {
                    ...
                    ajax.open("GET", "http://localhost:8080/https://rule34.xxx/public/autocomplete.php?q=" + val, true);
