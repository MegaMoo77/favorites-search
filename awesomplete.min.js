        ...
        elem.oninput = function(evt) {
            ...
            if (val != null) {
                ...
                if (evt.keyCode == 32) {
                    ...
                    var xmlResponse = fetch("https://cors-anywhere3.onrender.com/https://rule34.xxx/public/autocomplete.php?q=" + val, {headers:headers})
                        .then( (response) => {
                            if (!response.ok) {
                    ...
                    ajax.open("GET", "https://cors-anywhere3.onrender.com/https://rule34.xxx/public/autocomplete.php?q=" + val, true);
